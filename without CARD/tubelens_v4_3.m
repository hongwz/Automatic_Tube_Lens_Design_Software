%%  Introduction program without CARD

% This program is used to realise automatic tube lens design with a pair of
% achromatic doublets from stock optics without using the CARD Zemax
% optimisation operand.
...
for bz1 = 1:size(lens_catalogN1,1)
    ...
    if((lens_catalogN1(bz1,3)>= 2*ft) && (lens_catalogN2(bz2,3)<=2*ft)||(lens_catalogN1(bz1,3)<=2*ft))
       ...
       %Insert lens1
        ...
        %aperture_d = LensCatalogs.MinEPD
        %effl = LensCatalogs.MinEFL
        LensCatalogs.Run();
...
%% %make thicknesses variable
        ...
        %% calculate the distance before the first surface for optimisation

        Radius_1 = Surface_1.Radius;
        Radius_2 = Surface_2.Radius;
        Radius_3 = Surface_3.Radius;
        Radius_4 = Surface_4.Radius;
        Radius_5 = Surface_5.Radius;
        Radius_6 = Surface_6.Radius;
        Radius_7 = Surface_7.Radius;

        
         
        Operand_2=TheMFE.InsertNewOperandAt(2);
        Operand_2.ChangeType(ZOSAPI.Editors.MFE.MeritOperandType.INDX);
        Operand_2.Weight = 0.0;
        Operand_2.GetCellAt(2).IntegerValue = 1;
        
        Operand_3=TheMFE.InsertNewOperandAt(3);
        Operand_3.ChangeType(ZOSAPI.Editors.MFE.MeritOperandType.INDX);
        Operand_3.Weight = 0.0;
        Operand_3.GetCellAt(2).IntegerValue = 2;
        
        Operand_4=TheMFE.InsertNewOperandAt(4);
        Operand_4.ChangeType(ZOSAPI.Editors.MFE.MeritOperandType.INDX);
        Operand_4.Weight = 0.0;
        Operand_4.GetCellAt(2).IntegerValue = 3;
        
        Operand_5=TheMFE.InsertNewOperandAt(5);
        Operand_5.ChangeType(ZOSAPI.Editors.MFE.MeritOperandType.INDX);
        Operand_5.Weight = 0.0;
        Operand_5.GetCellAt(2).IntegerValue = 4;     
      
        Operand_6=TheMFE.InsertNewOperandAt(6);
        Operand_6.ChangeType(ZOSAPI.Editors.MFE.MeritOperandType.INDX);
        Operand_6.Weight = 0.0;
        Operand_6.GetCellAt(2).IntegerValue = 5; 
        
        Operand_7=TheMFE.InsertNewOperandAt(7);
        Operand_7.ChangeType(ZOSAPI.Editors.MFE.MeritOperandType.INDX);
        Operand_7.Weight = 0.0;
        Operand_7.GetCellAt(2).IntegerValue = 6; 
        
        Operand_8=TheMFE.InsertNewOperandAt(8);
        Operand_8.ChangeType(ZOSAPI.Editors.MFE.MeritOperandType.INDX);
        Operand_8.Weight = 0.0;
        Operand_8.GetCellAt(2).IntegerValue = 7;  
        
        Operand_9=TheMFE.InsertNewOperandAt(9);
        Operand_9.ChangeType(ZOSAPI.Editors.MFE.MeritOperandType.EFFL);
        Operand_9.Target = ft;
        Operand_9.Weight = 1.0;
        ...
        Index_1 = Operand_2.Value;
        
        Index_2 = Operand_3.Value;
        
        Index_3 = Operand_4.Value;

        Index_4 = Operand_5.Value;

        Index_5 = Operand_6.Value;

        Index_6 = Operand_7.Value;

        Index_7 = Operand_8.Value;
        
        
        Thickness_1 = Surface_1.Thickness;
        Thickness_2 = Surface_2.Thickness;
        Thickness_3 = Surface_3.Thickness;
        Thickness_5 = Surface_5.Thickness;
        Thickness_6 = Surface_6.Thickness;
        Thickness_7 = Surface_7.Thickness;

b = ft;%telecentric means b equals to the focal length

for t_3 = 0:ac:d_max_a
...
Mat = Sur6*T5*Sur5*T4*Sur4*T3*Sur3*T2*Sur2*T1*Sur1;
A = Mat(1,1);
B = Mat(1,2);
C = Mat(2,1);
D = Mat(2,2);
...
F = -1/C;
        ...
        Operand_10=TheMFE.InsertNewOperandAt(10);
        Operand_10.ChangeType(ZOSAPI.Editors.MFE.MeritOperandType.TTHI);
        Operand_10.Target = double(d_L1O2);
        Operand_10.Weight = telecentric;
